...
Переводите строго столько, сколько написано в поле 'Стоимость'. В противном случае могут возникнуть трудности \
с доступом в канал!

После перевода нажмите на кнопку подтверждения, для проверки""")
